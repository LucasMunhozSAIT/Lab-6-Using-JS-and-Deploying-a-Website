/****************** YOUR NAME: Lucas Munhoz da Costa.
...
function recalculate() {
    let costLabel = document.getElementById("calculated-cost"); /* Acessing Elements by ID - Slide 4 */
...
let modelButton = document.getElementById("model-button"); /* Acessing Elements by ID - Slide 4 */
let modelText = document.getElementById("model-text"); /* Acessing Elements by ID - Slide 4 */
...
let durationButton = document.getElementById("duration-button"); /* Acessing Elements by ID - Slide 4 */
let durationText = document.getElementById("duration-text"); /* Acessing Elements by ID - Slide 4 */

function changeDuration() {

    let newDuration = prompt("How many days?"); /* Prompt Box - Slide 31 */
    duration = parseInt(newDuration) || 0; /*W3 School = this method parses a value as a string and returns the first integer*/
